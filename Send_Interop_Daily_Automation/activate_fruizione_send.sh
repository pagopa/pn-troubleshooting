...
curl 'https://selfcare.interop.pagopa.it/1.0/backend-for-frontend/agreements?states=PENDING&limit=50&offset=0&producersIds=4a4149af-172e-4950-9cc8-63ccc9a6d865' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:133.0) Gecko/20100101 Firefox/133.0' \
