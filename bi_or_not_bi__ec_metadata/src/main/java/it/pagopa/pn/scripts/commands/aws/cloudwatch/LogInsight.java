package it.pagopa.pn.scripts.commands.aws.cloudwatch;
...
public class LogInsight {
    ...
    public List<JSONObject> executeLogInsightQuery(Collection<String> logGroupsNames, long fromEpochMs, long toEpochMs, String query, int limit ) {
        busyWait( 2 );
