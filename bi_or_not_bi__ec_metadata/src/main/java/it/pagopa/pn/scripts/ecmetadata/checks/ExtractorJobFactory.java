...
public class ExtractorJobFactory {
    ...
    public static ExtractorJobFactory newInstance(
                       SparkSqlWrapper spark, Path outputFolder, String barCharDataCsvFileName ) {
        return new ExtractorJobFactory( spark, outputFolder, barCharDataCsvFileName);
    }
    ...
    private ExtractorJobFactory(SparkSqlWrapper spark, Path outputFolder, String barCharDataCsvFileName) {
        this.spark = spark;
