...
const { S3Client, GetObjectCommand, PutObjectCommand, ListObjectVersionsCommand, DeleteObjectCommand} = require("@aws-sdk/client-s3");
...
class AwsClientsWrapper {
  ...
  */
  ...
  async _listObjectVersions(bucket, fileKey) {
    const input = {
      Bucket: bucket,
      Prefix: fileKey
    };
  ...
  async _deleteObject(bucket, fileKey, versionId) {
    const input = {
      Bucket: bucket,
      Key: fileKey,
      VersionId: versionId
