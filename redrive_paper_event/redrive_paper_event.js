...
Si parte dal requestId
CON998 Scan con filtro (Next)
Account Pn-confinfo
Rinominare i record Tabelle in 
- pn-EcRichieste
- pn-EcRichiesteMetadati

prendere in
pn-cons-000~<request-id>.PCRETRY_0
e rinominare in 
pn-cons-000~<request-id>.PCRETRY_0.OLD

rinominare riga pn-paperRequestError da -> <request-id> a <request-id>_TMP



Core Account (non deve esserci il requestId)
Fare un put nella Coda SQS pn-paper_channel_requests invio e ricevi messaggi si prende il payload e lo modifica con
{
...
Aggiungere MessageAttributes:
{
	attempt 	- String 	- 1
	createdAt 	- String 	- NOW()
	eventId 	- String 	- UUID generato
	eventType 	- String	- SAFE_STORAGE_ERROR
	expired 	- String 	- NOW()+1 secondo
	publisher 	- String 	- paper-channel-prepare
}



su core test è possibile fare esempi usando error CON996
*/
