...
const { DynamoDBClient, ScanCommand, GetItemCommand, PutItemCommand, QueryCommand, DeleteItemCommand } = require("@aws-sdk/client-dynamodb");
...
class AwsClientsWrapper {
  ...
  async removeFutureActions( iun ) {
    ...
    let queryResponse = await this._dynamoClient.send(new QueryCommand(queryInput));
